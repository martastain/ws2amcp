# Based on websockets-server by Johan Hanssen Seferidis
# License: MIT
...
class WebSocketHandler(StreamRequestHandler):
    ...
    def send_text(self, message):
        ...
        if isinstance(message, bytes):
            ...
            logging.warning('Can\'t send message, message has to be a string or bytes. Given type is %s' % type(message))
            return False
